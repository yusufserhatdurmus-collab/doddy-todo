...
Teknik Altyapı
Uygulamanın ön yüzü React ve Vite kullanılarak geliştirildi. Verilerin kalıcı olması ve kullanıcı yönetimi için Firebase Firestore ve Firebase Auth servislerinden yararlanıldı. Uygulama, Vercel üzerinden sürekli canlı tutulmaktadır.
